...
#define CONFIG_EXAMPLES_DIR "config/Creality/CR-10 V2"
 ...
 */
#define E0_AUTO_FAN_PIN P2_04   //P2_04 Connect Hotend Fan Extruder Heater pin
...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  #define Z_STEPPER_ALIGN_XY { {  60, 150 }, { 280, 150 } }
